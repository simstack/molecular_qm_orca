"""Heartbeat process that keeps writing while the parent waits on ORCA."""
...
def _insert_mongo(collection, message: str, task_id: str):
    ...
    record = {
        ...
        "level": "INFO",
        "logger_name": "orca_heartbeat",
        "message": f"Task orca: {message} task_id: {task}",
...
class ProcessHeartbeat:
    """Child process that appends heartbeat lines even when the parent is blocked."""
